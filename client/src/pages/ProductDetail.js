            ...
            loading ? ( <
                ...
                div > {
                    product.reviews.map((review, index) => ( <
                        ...
                        /> <
                        /div> <
                        div className = 'productDetail__review__container__item' > { review.createdAt.substring(0, 10) } <
                        /div> <
                        div className = 'productDetail__review__container__item__content' > { review.comment } <
                        /div> <
                        /div>
                    ))
                } <
