...
function App() {
    ...
    <Route exact path = '/shop/page/:pageNumber' component = { ProductsPage }/>  
    <Route exact path = '/admin/productlist' component = { ProductManagePage }/>  
    <Route exact path = '/admin/productlist/:pageNumber' component = { ProductManagePage }/>  
    <Route exact path = '/admin/product/create' component = { ProductAddPage }/>  
    <Route exact path = '/admin/product/:id/edit' component = { ProductEditPage }/>  
    <Route exact path = '/shop/category/:category' component = { ProductsPage }/>  
    <Route exact path = '/shop/product/:id' component = { ProductDetail }/>  
    <Route exact path = '/shop/search' component = { SearchPage }/>  
    <Route exact path = '/shop/search/:keyword' component = { SearchPage }/>  
    <Route exact path = '/shop/search/:keyword/page/:pageNumber' component = { SearchPage }/>  
    ...
    <Route path='/' render={({ location }) => location.pathname !== '/' && <Footer />}/>
      </Router>  
    </div>
    );
}
